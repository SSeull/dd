...
slack_token = "xoxb-506472500310-508556658279-6gjJdahAcFT4A7re3ORl2NC8"
slack_client_id = "506472500310.507503333842"
slack_client_secret = "9d9704eab8d4469212872054e47b97de"
slack_verification = "IjHeYoDSg1mAOq0JPGbPf0uQ"
...
def _crawl_cotents_top(text):
    ...
    if "뮤지컬" in text:
        ...
        print("공연 Top10")
    print(text)
    url = "http://ticket.interpark.com/contents/Ranking/RankList?pKind=" + url_str + "&pCate=&pType=D&pDate=20181221"
...
def _crawl_place_search(text):
    print(type(text))
    url = "http://ticket.interpark.com/contents/Ranking/RankList?pKind=P&pCate=&pType=D&pDate=20181221"
    req = urllib.request.Request(url)
    sourcecode = urllib.request.urlopen(url).read()
    soup = BeautifulSoup(sourcecode, "html.parser")
